        ...
        ClientLifecycleEvents.CLIENT_STARTED.register(client -> { //For attaining the original FPS.
            ...
            ClientTickEvents.END_CLIENT_TICK.register(client1 -> { //Every tick
                if (client.player!=null) {
                    if(Option.FRAMERATE_LIMIT.get(client.options)!=defaultFPS.get() && Option.FRAMERATE_LIMIT.get(client.options)!=Configuration.getInstance().frameDropMaximumFrames) {
